...
export const codes = [
    ...
    },
    {
        ...
        code: "",
    },
]
...
<span class="hljs-class"><span class="hljs-keyword">contract</span> <span class="hljs-title">PoolInitialize</span> </span>{
    ...
    IPoolManager manager <span class="hljs-operator">=</span> IPoolManager(<span class="hljs-keyword">address</span>(<span class="hljs-number">0x01</span>));
